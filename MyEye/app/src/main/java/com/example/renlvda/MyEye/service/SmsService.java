package com.example.renlvda.MyEye.service;
...
import com.example.renlvda.MyEye.view.DispatchLinearLayout;

/**
 * 项目名:  MyEye
 * 包名:    com.example.renlvda.MyEye.service
 * 文件名:  SmsService
 * 创建者:  任律达
 * 创建时间:  2017/11/10 23:18
 * 描述:    短信监听服务
 */
public class SmsService extends Service implements View.OnClickListener {
    ...
    private void init() {
        ...
        //设置权限
        intent.setPriority(Integer.MIN_VALUE);
        //注册
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (StaticClass.SMS_ACTION.equals(action)) {
                ...
                for (Object obj : objs) {
                    ...
                    L.i("短信的内容:" + smsContent + "发件人:" + smsPhone);
                    showWindow();
                }
            }
        }
